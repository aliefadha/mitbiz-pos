...
function SettingsPage() {
  ...
  const { data: hasUpdatePermission } = useQuery({
    queryKey: ['permission', 'tenants', 'update'],
    queryFn: async () => {
      const { allowed } = await checkPermission('tenants', 'update');
      return allowed;
    },
    enabled: !!tenantId,
  });

  const canUpdate = hasUpdatePermission ?? false;
              ...
              <Card>
                <CardContent>
                  ...
                  <div className="flex flex-col items-center mb-6">
                    ...
                    <Button variant="outline" size="sm" type="button" disabled={!canUpdate}>
