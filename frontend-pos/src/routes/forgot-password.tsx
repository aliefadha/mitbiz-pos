        ...
        <div className="flex-1 flex flex-col justify-center w-full max-w-[500px] lg:max-w-[700px] mx-auto rounded-2xl bg-white p-5 px-10 lg:p-24 shadow-sm overflow-y-auto">
          {!success ? (
            ...
            <div className="text-center">
              ...
              <p className="mt-3 text-xs lg:text-sm leading-relaxed text-gray-500">
              ...
              <div className="mt-8 space-y-3">
                <Button
                  ...
                  variant="outline"
                  className="h-10 lg:h-12 w-full rounded-full border-gray-200 text-sm lg:text-base font-semibold text-gray-700 shadow-sm transition-all hover:bg-gray-50 active:scale-[0.98]"
                >
                  Coba Email Lain
                </Button>
